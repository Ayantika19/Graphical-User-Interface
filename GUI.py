...
Subtraction=Button(f2,padx=16,pady=16,bd=4, fg="black", font=('ariel', 20 ,'bold'),text="-",bg="powder blue", command=lambda: btnclick("-") )
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-By Ayantika Sarkar",bd=2,relief=SUNKEN)
